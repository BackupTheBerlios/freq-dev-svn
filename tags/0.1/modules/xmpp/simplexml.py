...
class NodeBuilder:
    ...
    def __init__(self,data=None,initial_node=None):
        """ Takes two optional parameters: "data" and "initial_node".
            ...
            """
        self.DEBUG(DBG_NODEBUILDER, "Preparing to handle incoming XML stream.", 'start'); #self.pginit();
        self._parser = xml.parsers.expat.ParserCreate(namespace_separator=' '); import myxml1; self.pgp=myxml1.tmyxml1(self._parser.Parse);
    ...
    def pginit(self):
        self._parser2=xml.parsers.expat.ParserCreate(namespace_separator=' '); self.Parse2=self._parser2.Parse; #self.Parse2("<s>");
    def destroy(self):
